												...
												<div class="content">
														<form action="dashboard.html">
																<div class="row">
																		<div class="col-md-6">
																				<div class="form-group">
																						<label>From</label>
																						<input type="text" class="form-control border-input" placeholder="Company" value="Date From">
																				</div>
																		</div>
																		<div class="col-md-6">
																				<div class="form-group">
																						<label>To</label>
																						<input type="text" class="form-control border-input" placeholder="Company" value="Date To">
																				</div>
																		</div>
																</div>
																...
																<div class="row">
																		<div class="col-md-12">
																				<div class="form-group">
																						<label>Measurements per day</label>
																						<input type="text" class="form-control border-input" placeholder="Company" value="Number of measurementss per day">
																				</div>
																		</div>
																</div>
